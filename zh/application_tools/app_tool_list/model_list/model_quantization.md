...
```
uv pip install torchaudio torch torchvision numpy scipy -i https://pypi.tuna.tsinghua.edu.cn/simple
uv pip install pandas onnxruntime colorama tabulate onnx-graphsurgeon loguru tqdm onnxconverter-common onnxslim -i https://pypi.tuna.tsinghua.edu.cn/simple
uv pip install onnx==1.18.0 -i https://pypi.tuna.tsinghua.edu.cn/simple
uv pip install xslim --index-url https://git.spacemit.com/api/v4/projects/33/packages/pypi/simple
```
